    ...
    render(){
        return(
            ...
            <View style={{flex:1}}>
            {
              ...
              <Text>{"List of Books Requested By Our Users  would be here, " + firebase.auth().currentUser.email + ". However, as of now, there are no pending requests. To make one, go to the exchange screen."}</Text>
              </View>)  
              :
              (
